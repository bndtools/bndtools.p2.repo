    ...
    local json_payload=$(cat <<EOF
{
    ...
    "basic": {
        "publicDescription": "bndtools p2 release 6.4.1",
        "internalDescription": "",
        "includesPattern": "**/*",
        "excludesPattern": "",
        ...
        "p2Repos": [
            {
                ...
                "pathSuffix": "libs-release-local/org/bndtools/org.bndtools.p2/6.4.1/org.bndtools.p2-6.4.1.jar!",
                "action": "include",
                "repoUrl": "local://libs-release-local/libs-release-local/org/bndtools/org.bndtools.p2/6.4.1/org.bndtools.p2-6.4.1.jar!"
            }
        ]
    }
}
